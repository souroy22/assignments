...
function proxyNLP(nlpType, query) {
    return __awaiter(this, void 0, void 0, function () {
        var _this = this;
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                    var error, token, apiTmp, urlType, url;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                error = checkInit();
                                ...
                                apiTmp = api;
                                urlType = apiTmp[nlpType];
                                url = urlType + "/" + auth_1.TOKEN;
                                return [4 /*yield*/, request_1.default.post(url, {
                                        json: {
                                            query: token
                                        }
